    ...
    PlanetContext<INTER_SLOTS, MessageType>
{
    ...
    pub fn new(world_arena_size: usize, anti_msg_arena_size: usize, world_id: usize, terminal: u64) -> Self {
        Self {
...
pub trait ThreadedAgent<const SLOTS: usize, MessageType: Pod + Zeroable + Clone> {
    fn step(&mut self, context: &mut PlanetContext<SLOTS, MessageType>, agent_id: usize) -> Result<Event, AikaError>;
    fn read_message(
        &mut self,
